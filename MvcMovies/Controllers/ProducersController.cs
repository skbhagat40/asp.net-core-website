...
namespace MvcMovies.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public ProducersController(MvcMoviesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var Movie = await _context.Movies.FirstAsync(m => m.ProducerId == producer.ProducerID);
        ...
        public async Task<IActionResult> Create([Bind("ProducerID,Name,Sex,DOB,Bio")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProducerID,Name,Sex,DOB,Bio")] Producer producer)
        {
